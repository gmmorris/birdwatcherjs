...
$(document).ready(function () {
	...
	test('should be able to birdwatcher function which has its own function property if watchProperties is true', function () {

		var msg = "noInitPony failed to wrap prop function";
	...
	test('should be able to birdwatcher function which has its own function property, with property functions when wrapping is set to false', function () {

		var msg = "noInitPony failed wrapped prop function when it shouldnt";
	...
	test('should be able to birdwatcher function which has its own function property, without wrapping property functions by default', function () {
